...
class BartForConditionalGenerationAndPointer(OrigBartForConditionalGeneration):
    ...
    def forward(
        ...
        predicted_pointers = self.pointer_net(outputs)
        pointer_loss = None
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            next_pointer_logits[~is_pointable] = float("-inf")
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if consider_pointer_prob_in_topk:
                ...
                next_pointers = (
                    selected_pointers.view(batch_size, num_beams, -1)
                    .gather(1, next_indices.unsqueeze(-1).expand(-1, -1, selected_pointers.shape[-1]))
                ...
                next_tokens = (
                    ...
                    .gather(1, next_indices.unsqueeze(-1).expand(-1, -1, selected_tokens.shape[-1]))
